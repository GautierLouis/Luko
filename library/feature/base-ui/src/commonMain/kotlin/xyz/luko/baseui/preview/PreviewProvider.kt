...
object PreviewProvider {
    ...
    val dictionaryGraphic: DictionaryWithGraphic by lazy {
        getDictionaryWithGraphic()
    }

    val dictionary: Dictionary by lazy {
        dictionaryGraphic.dictionary
    }
    ...
    val graphic: Graphic by lazy {
        dictionaryGraphic.graphics
    }
    ...
    private fun getDictionaryWithGraphic() = DictionaryWithGraphic(
        dictionary = Dictionary(
            ...
            radical = "走",
            matches = listOf(
                listOf(0), listOf(0), listOf(0), listOf(0), listOf(0), listOf(0), listOf(0),
                listOf(1), listOf(1), listOf(1), listOf(1), listOf(1),
            ),
        ),
        graphics = Graphic(
            code = 36229,
            ...
            medians = listOf(
                Stroke(
                    listOf(
                        Point.Straight(213.0f, 606.0f),
                        Point.Straight(271.0f, 601.0f),
                        Point.Straight(438.0f, 639.0f),
                        Point.Straight(489.0f, 639.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(326.0f, 813.0f),
                        Point.Straight(372.0f, 773.0f),
                        Point.Straight(362.0f, 529.0f),
                        Point.Straight(345.0f, 503.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(87.0f, 434.0f),
                        Point.Straight(148.0f, 427.0f),
                        Point.Straight(418.0f, 494.0f),
                        Point.Straight(465.0f, 502.0f),
                        Point.Straight(512.0f, 499.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(339.0f, 449.0f),
                        Point.Straight(369.0f, 422.0f),
                        Point.Straight(368.0f, 234.0f),
                        Point.Straight(387.0f, 205.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(401.0f, 330.0f),
                        Point.Straight(424.0f, 352.0f),
                        Point.Straight(456.0f, 356.0f),
                        Point.Straight(483.0f, 351.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(220.0f, 375.0f),
                        Point.Straight(245.0f, 338.0f),
                        Point.Straight(195.0f, 226.0f),
                        Point.Straight(167.0f, 183.0f),
                        Point.Straight(109.0f, 116.0f),
                        Point.Straight(55.0f, 75.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(257.0f, 271.0f),
                        Point.Straight(260.0f, 259.0f),
                        Point.Straight(295.0f, 232.0f),
                        Point.Straight(467.0f, 124.0f),
                        Point.Straight(561.0f, 75.0f),
                        Point.Straight(664.0f, 32.0f),
                        Point.Straight(725.0f, 15.0f),
                        Point.Straight(750.0f, 15.0f),
                        Point.Straight(947.0f, 41.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(547.0f, 669.0f),
                        Point.Straight(599.0f, 664.0f),
                        Point.Straight(777.0f, 705.0f),
                        Point.Straight(793.0f, 705.0f),
                        Point.Straight(815.0f, 687.0f),
                        Point.Straight(797.0f, 554.0f),
                        Point.Straight(770.0f, 494.0f),
                        Point.Straight(745.0f, 470.0f),
                        Point.Straight(668.0f, 508.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(627.0f, 651.0f),
                        Point.Straight(651.0f, 631.0f),
                        Point.Straight(655.0f, 618.0f),
                        Point.Straight(639.0f, 576.0f),
                        Point.Straight(582.0f, 479.0f),
                        Point.Straight(526.0f, 422.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(536.0f, 359.0f),
                        Point.Straight(566.0f, 324.0f),
                        Point.Straight(597.0f, 159.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(586.0f, 358.0f),
                        Point.Straight(594.0f, 350.0f),
                        Point.Straight(614.0f, 350.0f),
                        Point.Straight(729.0f, 374.0f),
                        Point.Straight(760.0f, 386.0f),
                        Point.Straight(791.0f, 378.0f),
                        Point.Straight(812.0f, 356.0f),
                        Point.Straight(780.0f, 263.0f),
                        Point.Straight(763.0f, 257.0f)
                    )
                ),
                Stroke(
                    listOf(
                        Point.Straight(615.0f, 189.0f),
                        Point.Straight(626.0f, 202.0f),
                        Point.Straight(750.0f, 224.0f),
                        Point.Straight(812.0f, 214.0f)
                    )
                ),
            ),
